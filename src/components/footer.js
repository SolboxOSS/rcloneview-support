        ...
        <div className="container">
          <div className="footerMobile" style={{ display: "flex", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <div className="col-lg-5 text-lg-end">
              <a className="link-dark text-decoration-none me-3" href="/src/about-us" style={{ color: "#6c757d" }}>
                About Us
              </a>
              <a className="link-dark text-decoration-none me-3" href="/src/privacy_policy" style={{ color: "#6c757d" }}>
                Privacy Policy
              </a>
              <a className="link-dark text-decoration-none me-3" href="/src/eula" style={{ color: "#6c757d" }}>
                EULA
              </a>
