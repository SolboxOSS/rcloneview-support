...
export default function SupportPage() {
  ...
  return (
    ...
    >
      <main className="px-0 mt-0 pb-8 bg-white">
        <div className="bg-gray-100 w-screen">
          <div className="py-12 flex flex-col items-center max-w-7xl mx-auto px-0">
            <h1 className="text-4xl font-bold text-center mb-6 text-gray-900">RcloneView Support Center</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl mx-auto mt-12">
          ...
          <a href="https://forum.rcloneview.com" target="_blank" rel="noopener noreferrer" className="bg-white p-6 rounded-xl border border-gray-200 shadow-md hover:shadow-xl transition duration-300 text-center">
            <div className="text-5xl mb-4">💬</div>
